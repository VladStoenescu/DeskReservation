    ...
    <div>
      ...
      <div className="info-section">
        ...
        <ol className="info-steps">
          <li>Click <strong>Book Desk</strong> in the navigation bar.</li>
          ...
          <li>Click <strong>Save Booking</strong> to confirm.</li>
        </ol>
      </div>
      ...
      <div className="info-section">
        ...
        <ol className="info-steps">
          <li>Click <strong>Bookings</strong> in the navigation bar.</li>
          <li>Find the booking you want to remove.</li>
          <li>Click <strong>✕ Remove</strong> and confirm inline — no pop-up.</li>
        </ol>
      </div>
    </div>
  )
